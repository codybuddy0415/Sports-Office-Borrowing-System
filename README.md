      ...
      <div class="main">
        ...
        <div id="equipment" class="hidden">
          ...
          <div class="top-actions">
            <input
              type="text"
              placeholder="🔎︎ Search equipment..."
        ...
        <div id="borrow" class="hidden">
          ...
          <div class="top-actions">
            <input
              type="text"
              placeholder="🔎︎ Search student or item..."
      ...
      function render() {
        ...
        borrowers.forEach((b, i) => {
          ...
          <tr>
              ...
              <td>${b.due}</td>
              <td>${b.returned}</td>
              <td>${b.status !== "Returned" ? `<button class="action return" onclick="returnItem(${i})">Return</button>` : "—"}</td>
            </tr>`;
          dashboardBorrowers.innerHTML += `
            <tr>
                <td>${b.name}</td>
